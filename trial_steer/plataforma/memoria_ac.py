...
VERIFICADA en Assetto Corsa 1.16.4. Su disponibilidad se revisa por corrida en
la pestaña Verificación de la plataforma, y cada lectura comprueba que los
puntos de contacto sean coherentes antes de usarlos. Si no lo son, se usa el
traslado de respaldo de la configuración.
...
def construir_estado(gr, ph, cfg_vehiculo, t_lectura, fisica_ampliada):
    ...
    ψ es la orientación de la carrocería. Los ejes salen de los puntos de
    contacto cuando pasan las comprobaciones. Si no,
