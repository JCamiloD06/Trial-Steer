"""
Plan de sintonía de los tres controladores laterales.
...
RUTA_RANGOS = RAIZ_APP / "configs" / "rangos_sintonia.json"
RUTA_PLAN = RAIZ_APP / "configs" / "plan_sintonia.json"
DIR_CONFIGS = RAIZ_APP / "configs" / "sintonia"
...
def escribir_configs(plan, config_base, dir_configs=DIR_CONFIGS):
    ...
    for corrida in plan["corridas"]:
        ...
        cfg["_descripcion"] = (f"Corrida {corrida['id_plan']} del plan de sintonía con semilla "
