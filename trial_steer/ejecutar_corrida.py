"""
Una corrida en Assetto Corsa con un controlador lateral y un perfil.
...
apenas termina el cálculo y duerme lo que falte para completar
el periodo nominal. La corrida termina al completar la vuelta medida,
con Ctrl+C, al aparecer el archivo de detención que crea el lanzador o al
...
def main():
    ...
    ap.add_argument("--config", default=str(RAIZ_APP / "configs" / "base.json"))
