"""
Seguimiento de la vuelta medida.
...
de Assetto Corsa no cuenta el primer cruce después de la salida, de modo que
con él la vuelta medida empezaría tras una vuelta completa de calentamiento. El
