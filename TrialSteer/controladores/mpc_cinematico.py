...
Modelo de predicción lineal en errores del eje trasero, discretizado con
...
Restricciones comunes, |δ[k]| ≤ δmax y |δ[k] - δ[k-1]| ≤ Δδmax Ts.

El problema condensado es un QP en δ[0..N-1] resuelto con OSQP.
Si OSQP no devuelve solved, se aplica la secuencia anterior desplazada.
OSQP tiene un tiempo máximo por ciclo, 40 ms por defecto.
