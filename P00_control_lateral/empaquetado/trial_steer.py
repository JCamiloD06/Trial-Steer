...
import numpy, scipy, scipy.sparse, scipy.stats, scipy.optimize, scipy.io, osqp  # noqa: E401,F401
...
def utf8():
    ...
    ψ ni δ. Sin esto la corrida se cae en la primera línea de salida, verificado
    el 2026-09-24 con las pruebas automáticas ejecutadas desde el ejecutable.
    """
...
def main():
    ...
    if args and args[0].lower().endswith(".py"):
        ...
        return
    os.chdir(BASE)
    ejecutar_script(BASE / "P00_control_lateral" / "abrir_lanzador.py", [])
